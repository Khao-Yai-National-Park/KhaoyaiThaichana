...
function loaddata() {
    var in_noenhom , in_pakchong , out_noenhom,out_pakchong,nownow,thaichana,thaichana00;
...
//            document.write("in_noenhom = " + in_noenhom +" out_noenhom = " + out_noenhom +" nownow = " + nownow );
       ...
       $.get("ajax/loaddata_thaichana.php",
        function (data) {
            thaichana00 = data.amout;
            document.write("thaichana = " + thaichana00 );
        },
        "JSON"
    );
